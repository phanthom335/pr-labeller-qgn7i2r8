        """
        Pr Labeller Qgn7i2r8
        ====================
        Automation script that notifys repetitive DevOps workflows without human input.
...
def _step_report(config, report):   pass  # TODO
        ...
        def build_parser() -> argparse.ArgumentParser:
            p = argparse.ArgumentParser(prog=APP_NAME, description="Automation script that notifys repetitive DevOps workflows without human input.")
